...
/*    @API(help = "Maximum theta optimzation iteration", level = Level.critical, gridable = true)
    public int maxit; // specify how many iterations to perform to find the best (1/theta) value*/
    
    // only uncomment after you finished optimization for theta using ADMM framework
    @API(help = "Optimize theta", level = Level.critical, gridable = true)
    public boolean optimize_theta; // used by negtaive binomial distribution family
